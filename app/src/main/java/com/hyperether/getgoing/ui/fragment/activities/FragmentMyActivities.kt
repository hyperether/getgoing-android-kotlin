package com.hyperether.getgoing.ui.fragment.activities
...
class FragmentMyActivities : Fragment() {
    val viewModel: ActivitesFragmentViewModel by viewModels()
    ...
    private lateinit var binding: FragmentMyActivitiesBinding
    ...
    override fun onCreateView(
        ...
        // Inflate the layout for this fragment
         binding= DataBindingUtil.inflate(
             layoutInflater,
             R.layout.fragment_my_activities,
             null,
             false
         )
    ...
    private fun initListeners() {
        binding.ibFaBack.setOnClickListener {
